...
// 关键函数必须存在（防漏贴类缺陷）
const critical = ['spendSummary', 'todaySpend', 'monthSpend', 'last30dSpend', 'costOf', 'sessionTotals', 'computePricing', 'computeEstimate', 'getUsageSummary', 'refreshAllBalances', 'modelDisplayFromCache', 'providerDisplayFromCache', 'refreshModelCatalog', 'detectBillingMode', 'parseOpenCodeGoUsage', 'parseCommandCodeUsage', 'parseMinimaxTokenPlanRemains', 'minimaxAggregateRemainingPercents', 'minimaxRemainingPercent', 'minimaxNumericField', 'minimaxBaseUrl', 'mergeSubscriptionResult', 'kickSubscriptionRefresh', 'getSubscriptionSnapshotRpc', 'readCodexAuthFile', 'fetchCodexUsage', 'fetchOpenCodeGoUsage', 'fetchCommandCodeUsage', 'fetchMinimaxTokenPlanUsage', 'resolveMinimaxKey'];
