...
const builtins = new Set([
  ...
  // Node 标准库导入与全局（静态形态）
  'existsSync', 'mkdirSync', 'readFileSync', 'readdirSync', 'renameSync', 'statSync', 'openSync', 'writeSync', 'fsyncSync', 'closeSync', 'randomUUID', 'createHash', 'createHmac', 'homedir', 'join', 'dirname',
