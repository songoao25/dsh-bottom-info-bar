...
module.exports = {
  ...
  async apply(ctx) {
    ...
    function BottomInfoBar(props) {
      ...
      var BILLING_PROVIDERS = ['together', 'fireworks', 'amazon-bedrock', 'cloudflare-ai-gateway', 'cloudflare-workers-ai'];
